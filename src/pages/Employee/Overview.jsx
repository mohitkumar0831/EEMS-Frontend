  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
        {/* Submitted Claims */}
        <div className="flex items-center justify-between gap-3 rounded-3xl border border-white/10 bg-slate-900/60 p-5 shadow-xl hover:border-indigo-500/20 transition-all duration-300">
          <div className="flex flex-col gap-1.5 min-w-0">
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-450 truncate" title="Submitted Claims">Submitted Claims</span>
            <span className="text-2xl lg:text-xl xl:text-3xl font-extrabold text-slate-100 break-words" title={totalClaims}>{totalClaims}</span>
          </div>
        ...
        <div className="flex items-center justify-between gap-3 rounded-3xl border border-white/10 bg-slate-900/60 p-5 shadow-xl hover:border-indigo-500/20 transition-all duration-300">
          <div className="flex flex-col gap-1.5 min-w-0">
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-450 truncate" title="Pending Review">Pending Review</span>
            <span className="text-2xl lg:text-xl xl:text-3xl font-extrabold text-slate-100 break-words" title={pendingClaimsCount}>{pendingClaimsCount}</span>
          </div>
        ...
        <div className="flex items-center justify-between gap-3 rounded-3xl border border-white/10 bg-slate-900/60 p-5 shadow-xl hover:border-indigo-500/20 transition-all duration-300">
          <div className="flex flex-col gap-1.5 min-w-0">
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-450 truncate" title="Approved (Unpaid)">Approved (Unpaid)</span>
            <span className="text-2xl lg:text-xl xl:text-3xl font-extrabold text-slate-100 break-words" title={approvedClaimsCount}>{approvedClaimsCount}</span>
          </div>
        ...
        <div className="flex items-center justify-between gap-3 rounded-3xl border border-white/10 bg-slate-900/60 p-5 shadow-xl hover:border-indigo-500/20 transition-all duration-300">
          <div className="flex flex-col gap-1.5 min-w-0">
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-450 truncate" title="Reimbursed">Reimbursed</span>
            <span className="text-2xl lg:text-xl xl:text-3xl font-extrabold text-slate-100 break-words" title={totalReimbursedCount}>{totalReimbursedCount}</span>
          </div>
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-blue-500/20 bg-blue-500/10 text-blue-400">
            <CheckCircle2 className="h-6 w-6 shrink-0" />
          </div>
        ...
        <div className="flex items-center justify-between gap-3 rounded-3xl border border-white/10 bg-slate-900/60 p-5 shadow-xl hover:border-indigo-500/20 transition-all duration-300">
          <div className="flex flex-col gap-1.5 min-w-0">
            <span className="text-xs font-semibold uppercase tracking-wider text-slate-450 truncate" title="Total Reimbursed">Total Reimbursed</span>
            <span className="text-2xl lg:text-xl xl:text-3xl font-extrabold text-slate-100 break-all" title={`₹${totalReimbursed.toFixed(2)}`}>₹{totalReimbursed.toFixed(2)}</span>
          </div>
